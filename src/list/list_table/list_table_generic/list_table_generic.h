 ...
 *              va a buon fine
 * */
pvoid malloc_list_with_resize_table_generic(unsi dim_array, type_resize type_resize);
 ...
 *
 * */
pvoid change_resize_table_table_generic(pvoid plist, type_resize type_resize);
