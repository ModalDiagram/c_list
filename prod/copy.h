...
/* insert_first_int: inserisce un elemento di tipo int in cima alla lista.
...
*
* Se la lista non contiene elementi di tipo int ritorna 0.
* */
int insert_first_int(pvoid plist, int value);

/* insert_first_float: inserisce un elemento di tipo float in cima alla lista.
* plist:        lista al cui inizio inserire l'elemento
* value:        valore dell'elemento da inserire
* size:         deve essere rispettivamente:
*               - type_data_generic: dimensione del dato da inserire
...
* Torna 1 se tutto va bene, 0 altrimenti.
*
* Se la lista non contiene elementi di tipo float ritorna 0.
* */
int insert_first_float(pvoid plist, float value);

/* insert_first_double: inserisce un elemento di tipo double in cima alla lista.
* plist:        lista al cui inizio inserire l'elemento
* value:        valore dell'elemento da inserire
* size:         deve essere rispettivamente:
*               - type_data_generic: dimensione del dato da inserire
...
* Torna 1 se tutto va bene, 0 altrimenti.
*
* Se la lista non contiene elementi di tipo double ritorna 0.
* */
int insert_first_double(pvoid plist, double value);
...
* */
int insert_first_int(pvoid plist, int value);
/* insert_first_array_int: inserisce un array di elementi di tipo int in cima alla lista.
* plist:        lista al cui inizio inserire l'elemento
* paddr:        indirizzo dell'array da inserire
*
* Torna 1 se tutto va bene, 0 altrimenti.
*
* Se la lista non contiene array di elementi di tipo int ritorna 0.
* */
int insert_first_array_int(pvoid plist, pint paddr);
...
* */
int insert_first_float(pvoid plist, float value);
/* insert_first_array_float: inserisce un array di elementi di tipo float in cima alla lista.
* plist:        lista al cui inizio inserire l'elemento
* paddr:        indirizzo dell'array da inserire
*
* Torna 1 se tutto va bene, 0 altrimenti.
*
* Se la lista non contiene array di elementi di tipo float ritorna 0.
* */
int insert_first_array_float(pvoid plist, pfloat paddr);
...
* */
int insert_first_double(pvoid plist, double value);
/* insert_first_array_double: inserisce un array di elementi di tipo double in cima alla lista.
* plist:        lista al cui inizio inserire l'elemento
* paddr:        indirizzo dell'array da inserire
*
* Torna 1 se tutto va bene, 0 altrimenti.
*
* Se la lista non contiene array di elementi di tipo double ritorna 0.
* */
int insert_first_array_double(pvoid plist, pdouble paddr);
...
* */
int insert_first_array_int(pvoid plist, pint paddr);
/* extract_first_int: estrae l'elemento di tipo int in cima alla lista
* plist:         lista dal cui inizio estrarre l'elemento
* pvalue:        indirizzo in cui scrivere il valore dell'elemento estratto
*
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_int(pvoid plist, pint pvalue);
...
* */
int insert_first_array_float(pvoid plist, pfloat paddr);
/* extract_first_float: estrae l'elemento di tipo float in cima alla lista
* plist:         lista dal cui inizio estrarre l'elemento
* pvalue:        indirizzo in cui scrivere il valore dell'elemento estratto
*
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_float(pvoid plist, pfloat pvalue);
...
* */
int insert_first_array_double(pvoid plist, pdouble paddr);
/* extract_first_double: estrae l'elemento di tipo double in cima alla lista
* plist:         lista dal cui inizio estrarre l'elemento
* pvalue:        indirizzo in cui scrivere il valore dell'elemento estratto
*
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_double(pvoid plist, pdouble pvalue);
...
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_int(pvoid plist, pint pvalue);
/* extract_first_array_int: estrae l'array di elementi di tipo int in cima alla lista
* plist:         lista dal cui inizio estrarre l'elemento
* pvalue:        indirizzo in cui scrivere l'indirizzo dell'array estratto
*
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_array_int(pvoid plist, ppint ppaddr);
...
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_float(pvoid plist, pfloat pvalue);
/* extract_first_array_float: estrae l'array di elementi di tipo float in cima alla lista
* plist:         lista dal cui inizio estrarre l'elemento
* pvalue:        indirizzo in cui scrivere l'indirizzo dell'array estratto
*
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_array_float(pvoid plist, ppfloat ppaddr);
...
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_double(pvoid plist, pdouble pvalue);
/* extract_first_array_double: estrae l'array di elementi di tipo double in cima alla lista
* plist:         lista dal cui inizio estrarre l'elemento
* pvalue:        indirizzo in cui scrivere l'indirizzo dell'array estratto
*
* Torna 1 se tutto va bene, 0 altrimenti */
int extract_first_array_double(pvoid plist, ppdouble ppaddr);
